-- 1 List each county name where the population is larger than that of 'Russia'
SELECT name
FROM world
WHERE population>
    (SELECT population
...
-- 2 Show the countries in Europe with a per capita GDP higher than 'United Kingdom'    
SELECT name
FROM world
