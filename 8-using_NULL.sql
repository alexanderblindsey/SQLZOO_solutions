...
-- 2.  Note the INNER JOIN misses the teachers with no departments and the departments with no teacher.
...
SELECT name, CASE WHEN dept IN (1, 2) THEN 'Sci' ELSE 'Art' END dept_name
FROM teacher
